...
def main():
    ...
    draw_circles(rg.Point(300, 70))
    draw_circles(rg.Point(-20, 39))
    better_draw_circles(rg.Point(-249, -22), 5)
    better_draw_circles(rg.Point(300, -149), 10)
    even_better_draw_circles(rg.Point(100, 50), 20, 20, 'green', 6)
    even_better_draw_circles(rg.Point(-200, 0), 9, 13, 'blue', 2)
    even_better_draw_circles(rg.Point(-312, -200), 20, 20, 'green', 6)
    even_better_draw_circles(rg.Point(150, -234), 9, 13, 'blue', 2)
...
def even_better_draw_circles(point, radii, circle_num, color, pensize):
    ...
    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(color, pensize)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)

    for k in range(1, circle_num):
